public class JamSibuk {
  ...
  //upcasting, objek b dan f adalah new obj dengan tipe data Elemen(Superclass) pada class Dosen(Subclass), jadi melakukan proses pengubahan referensi subclass ke superclass//
  //upcasting, objek d dan e adalah new obj dengan tipe data Elemen(Superclass) pada class Mahasiswa(Subclass), jadi melakukan proses pengubahan referensi subclass ke superclass//